...
public class Student {
    ...
    public Student() {
        // No arguments sets height to 0
        this(null, null, 0);
    }

    /**
     * Compares the names of this student to paremeter 
     * student, returning an int value representing 
     * which name comes in first alphabetically.
     * 
    ...
    public int compareNameTo(Student other){
        int lnCompare = this.lastName.compareToIgnoreCase(other.getLastName());
        if(lnCompare == 0) return this.firstName.compareToIgnoreCase(other.getFirstName());
        return lnCompare;
    }
